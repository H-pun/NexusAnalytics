...
export interface IDeployService {
  ...
  getLastDeployment(projectId: number): Promise<Deploy | null>;
  getInProgressDeployment(projectId: number): Promise<Deploy | null>;
...
export class DeployService implements IDeployService {
  ...
  public async deploy(manifest: Manifest, projectId: number, force = false) {
